...
import com.example.mapmycar.MapActivity;
...
public class FirstActivity extends AppCompatActivity {
    ...
    private void userSign() {
        ...
        if (TextUtils.isEmpty(email)) {
            Toast.makeText(FirstActivity.this, "Enter the correct Email", Toast.LENGTH_SHORT).show();
            return;
        } else if (TextUtils.isEmpty(password)) {
            Toast.makeText(FirstActivity.this, "Enter the correct password", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        mAuth.signInWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if (!task.isSuccessful()) {
                    ...
                    Toast.makeText(FirstActivity.this, "Login not successfull", Toast.LENGTH_SHORT).show();
            ...
            private void createAnewUser(String uid) {
                ...
                Userid=uid;
                Toast.makeText(FirstActivity.this,Userid,Toast.LENGTH_SHORT).show();
            }
